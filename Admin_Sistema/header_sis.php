...
<body>
  ...
  <div class="color1">
	...
	<nav class="navbar navbar-dark navbar-expand-lg letra color2 ">
    
   	 <a class="navbar-brand" href="index.php">
       <img src="" width="320" height="30" class="d-inline-block align-top" alt=""> 
     </a>
    ...
    <center>
     <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
	   <div class="navbar-nav">
	      <a class="nav-item nav-link" href="agregar.php">Agregar</a>
	      <a class="nav-item nav-link" href="editar.php">Editar</a>
	      <a class="nav-item nav-link" href="eliminar.php">Elimar</a>
          <a class="nav-item nav-link" href="calendario.php">Calendario</a>
	      <a class="nav-item nav-link" href="periodo.php">Periodo</a>
	    </div>
	 </div>
    </center>
